...
const plans = [
    { id: 'basic', name: 'Basic Plan', amount: 50.00 },
  { id: 'silver', name: 'Silver Plan', amount: 85.00 },
  { id: 'gold', name: 'Gold Plan', amount: 150.00 },
];

const services = [
    { id: 'furn', name: 'Furniture Assembly', amount: 80.00 },
    { id: 'gutt', name: 'Gutter Cleaning', amount: 120.00 },
    { id: 'homerep', name: 'Home Repairs', amount: 60.00 },
    { id: 'paint', name: 'Painting', amount: 80.00 },
    { id: 'plumb', name: 'Plumbing', amount: 90.00 },
    { id: 'siding', name: 'House Siding', amount: 200.00 },
    { id: 'carp', name: 'Carpentry', amount: 60.00 },
    { id: 'elect', name: 'Electrical', amount: 70.00 },
    { id: 'outliv', name: 'Outdoor Living', amount: 400.00 },
    { id: 'pool', name: 'Pools', amount: 1000.00 },
    { id: 'hards', name: 'Hardscaping', amount: 600.00 },
    { id: 'patio', name: 'Patios', amount: 700.00 },
    { id: 'outkit', name: 'Outdoor Kitchens', amount: 1500.00 }
];
...
const PaymentsPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Payment submitted for ${selectedName} - $${selectedAmount.toFixed(2)}`);
    navigate('/');
  };
